...
export function consolidar(lista) {
  ...
  return {
    ...
    agendSF: sum(c=>c.agendSF||0),   agendBlip: sum(c=>c.agendBlip||0),
    visitasSF: sum(c=>c.visitasSF||0), visitasBlip: sum(c=>c.visitasBlip||0),
    propSF: sum(c=>c.propSF||0),     propBlip: sum(c=>c.propBlip||0),
    pvSF: sum(c=>c.pvSF||0),         pvBlip: sum(c=>c.pvBlip||0),
