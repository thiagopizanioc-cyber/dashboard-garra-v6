...
import { BotaoForm1 } from '../components/VendasExternas';
import { fmt, consolidar, semaforo, pontosDeAtencao } from '../utils/index';

export function P2_Superintendencia({ data, target, setTarget, setPage, getPhoto, raw }) {
    ...
    <div className="page">
      <div className="page-header">
        ...
        <div style={{display:'flex',gap:10,alignItems:'center'}}>
          <BotaoForm1 raw={raw} corretores={listaSuper}/>
